Module Module1
    ...
    Public Function fGetUTCTimestamp() As String
        ...
        sCurrentTimestanp = sCurrentTimestanp & Date.UtcNow.Year.ToString & "-"
        sCurrentTimestanp = sCurrentTimestanp & Microsoft.VisualBasic.Right("0" & Date.UtcNow.Month.ToString, 2) & "-"
        sCurrentTimestanp = sCurrentTimestanp & Microsoft.VisualBasic.Right("0" & Date.UtcNow.Day.ToString, 2)
        sCurrentTimestanp = sCurrentTimestanp & "T"
        sCurrentTimestanp = sCurrentTimestanp & Microsoft.VisualBasic.Right("0" & Date.UtcNow.Hour.ToString, 2) & "_"
        sCurrentTimestanp = sCurrentTimestanp & Microsoft.VisualBasic.Right("0" & Date.UtcNow.Minute.ToString, 2) & "_"
        sCurrentTimestanp = sCurrentTimestanp & Microsoft.VisualBasic.Right("0" & Date.UtcNow.Second.ToString, 2) & "."
        sCurrentTimestanp = sCurrentTimestanp & Microsoft.VisualBasic.Right("000" & Date.UtcNow.Millisecond.ToString, 3) & "Z"
